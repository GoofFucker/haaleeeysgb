...
client.on('guildMemberRemove', member => {
    ...
    member.guild.channels.get('549914111492882442').send(us2 + " Goodbye " + member + " Thanks for coming ! " + ayy2);
    member.guild.channels.get('549914111492882442').send(fr2 + " Au-revoir " + member + " Merci d'être passé ! " + ayy2);
...
client.on('guildMemberAdd', member => {
    ...
    member.guild.channels.get('549914111492882442').send(us2 + " Hi " + member + " Welcome to **NegativeNT** ! " + ayy);
    member.guild.channels.get('549914111492882442').send(fr2 + " Salut " + member + " Bienvenue sur **NegativeNT** ! " + ayy);
